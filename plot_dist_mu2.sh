...
exc "exp --exp_max 60 --exp_max_scale 15"
exc "exp --exp_max 200 --exp_max_scale 40"
exc "gauss --gauss_loc 60 --gauss_max_std 120"
exc "gauss --gauss_loc 200 --gauss_max_std 400"
